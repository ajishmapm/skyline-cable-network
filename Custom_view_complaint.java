...
public class Custom_view_complaint extends BaseAdapter {
    ...
    public Custom_view_complaint(Context applicationContext, String[] complaint, String[] cdate, String[] reply, String[] rdate, String[] user) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view==null)
        {
            ...
            gridView=inflator.inflate(R.layout.custom_view_complaint,null);//same class name
