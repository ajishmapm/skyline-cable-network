...
public class View_internet_channel_channels extends AppCompatActivity  {
    ListView lv;
...
//        String id=sh.getString("login_id","");
        url=sh.getString("url","")+"internet_channel_package_channels";
...
//                SharedPreferences sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
                ...
                params.put("cid",View_internet_channel_package.cid[View_internet_channel_package.pos] );
                return params;
            }
        };
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity( new Intent( this, View_internet_channel_package.class ) );
        finish();
    }
